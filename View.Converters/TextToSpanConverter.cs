...
namespace Mémoire.View.Converters
{
    ...
    public sealed class TextToSpanConverter : IValueConverter
    {
        ...
        readonly double _fontSize = (double)Application.Current.FindResource("BigFontSize");
        readonly Brush _matchForeground = (Brush)Application.Current.FindResource("MoreExamplesMatchForeground");
